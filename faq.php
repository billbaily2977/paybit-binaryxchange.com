...
<!-- End Header Section -->
    ...
    <title>FAQs | PayBit-BinaryXchange</title>
    

<!-- Start Hero Section -->
<section id="blog-page" class="page-wrap contact" style="margin-top:130px">
    <div class="hero-container container">
        <div class="hero-content">
            <div class="col-sm-12 m-auto text-center white">
                <h3 class="h1-md mb10 text-uppercase">FAQs </h3>
                <h4 class="subheading">Home/FAQs</h4>
            </div>
        </div>
    </div>
</section>
...
<section id="faq" class="pt120">
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingOne">
                            <h4 class="panel-title">
                                <a role="button"class="collapse" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body">
                                <p>You can withdraw your money in your personal account in the Withdraw Section. </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingTwo">
                            <h4 class="panel-title">
                                <a role="button" class="collapse" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                            <div class="panel-body">
                                <p>Yes, a minimum amount you can request for a withdrawal is 70% of your traded account in USD. </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading" role="tab" id="headingThree">
                            <h4 class="panel-title">
                                <a role="button" class="collapse" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                            <div class="panel-body">
                                <p>Withdrawal requests are processed instantly. Other transactions are approved and paid within 48 business hours.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseThree" class="panel-collapse" role="tabpanel" aria-labelledby="headingThree">
                            <div class="panel-body">
                                <p>There are no risks in any investment programs. There are some simple ways that we help to reduce risks of losing your money. First, set a certain financial goal and deposit such sum of money that you can afford. Remember that our expert trading team is always ready to consult you in any questions. </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseThree" class="panel-collapse" role="tabpanel" aria-labelledby="headingThree">
                            <div class="panel-body">
                                <p>You can check your balance in your personal account any time you need when you login to your account.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseThree" class="panel-collapse" role="tabpanel" aria-labelledby="headingThree">
                            <div class="panel-body">
                                <p>Your account is credited once payment is confirmed and it is from a few minutes. </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseThree" class="panel-collapse" role="tabpanel" aria-labelledby="headingThree">
                            <div class="panel-body">
                                <p>We accept Bitcoin,Bank Deposit, PayPal, Bitcoin Cash, Steller, Western Union, Moneygram, Etherium, Skrill and more. </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseThree" class="panel-collapse" role="tabpanel" aria-labelledby="headingThree">
                            <div class="panel-body">
                                <p>To make investments you should register to create an account and then you can make your deposit. All the investments are made in your personal account after login </p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6">
                <img src="img/icon/faqs.png" alt="" class="img-responsive">
            </div>
        </div>
    </div>
</section>
