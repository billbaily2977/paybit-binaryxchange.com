...
<div class="col-md-8 offset-md-8 text-left side_signing_full">
  <form class="form-signin1 full_side text-white " action="" method="POST">
    ...
    <input type="text" style="color:black;font-weight:bold" name="login" class="form-control" placeholder="Username" value="" required>
    <span style="color:crimson"></span>
    <br>
    <label style="color:black">Password</label>
    <input type="password" style="color:black;font-weight:bold" name="password" value="" class="form-control" placeholder="Password" required>
    <span style="color:crimson"></span>
    <br>
      ...
      <span style="color:crimson"></span>
      <br>
        <input type="checkbox" style="width:auto" name="remember" id="check" checked> <label for="check" style="color:black">Remember Me</label>
    <br>
