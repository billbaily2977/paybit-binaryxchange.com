...
<title>PayBit-BinaryXchange | Trading History</title>


<h2 style="text-align:center">Trading History < slide ></h2>
<br><br>
    ...
    <div class="scrollmenu">
        <table cellspacing="400" class="table" table-bordered="">
            <tbody>
                <tr>
                    <th>ASSETS</th>
                    <th style="width: 5%;"><img style="width: 20px; height: 10px;" src="img/BUY.png" alt="BUY" /> <img style="width: 20px; height: 10px;" src="img/SELL.png" alt="SELL" /><img style="width: 20px; height: 10px;" src="img/MINING.png" alt="MINING" /></th>
                    <th>AMOUNT</th>
                    <th>DATE</th>
                    <th>PAYOUT</th>
                                            <th>STATUS</th>
