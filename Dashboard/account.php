...
// Fetch user balances
$stmt = $pdo->prepare("SELECT total_deposit, balance, bonus, total_earning FROM users WHERE id = ?");
$stmt->execute([$userId]);
$user = $stmt->fetch(PDO::FETCH_ASSOC);

// Fallback to 0 if NULL
$user['total_deposit']  = $user['total_deposit'] ?? 0.00;
$user['balance']        = $user['balance'] ?? 0.00;
$user['bonus']          = $user['bonus'] ?? 0.00;
$user['total_earning']  = $user['total_earning'] ?? 0.00;
?>
  ...
  <nav class="navbar navbar-toggleable-md navbar-inverse bg-faded">
    ...
    <div class="sidebar-right pull-right ">
      <ul class="navbar-nav  justify-content-end">
        <li class="nav-item">
          <button class="btn-link btn userprofile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="userpic"><img src="<?php echo get_user_image_path(); ?>" alt="user pic"><span class="text"><?= $_SESSION['first_name'] ?> </span><?= $_SESSION['last_name'] ?></span>
          </button></li>
...
<title>PaybitBinaryExchange | Dashboard</title>


<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" crossorigin="anonymous" referrerpolicy="no-referrer" />    <div class="row mgt5">
        <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-4">
            <div class="activity-block success" style="border: 1px solid ">
                <div class="media">
                    <div class="media-body">
                        <h5 class="font-weight-bold" style="color:crimson">$<span class=""><?= number_format($user['total_deposit'], 2) ?></span></h5>
                        <p>Total Deposit</p>
                    </div>
                ...
                <div class="row">
                    <div class="progress ">
                        <div class="progress-bar" role="progressbar" aria-valuenow="0" aria-valuemin="0" aria-valuemax="100" style="width: 100%"><span class="trackerball"></span></div>
                    </div>
                </div>
        ...
        <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-4">
            <div class="activity-block success" style="border: 1px solid ">
                <div class="media">
                    <div class="media-body">
                        <h5 class="font-weight-bold" style="color:#070">$<span class=""><?= number_format($user['balance'], 2) ?></span></h5>
                        <p>Total Balance</p>
                    </div>
        ...
        <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-4">
            <div class="activity-block success" style="border: 1px solid ">
                <div class="media">
                    <div class="media-body">
                        <h5 class="font-weight-bold"><span class="">$<span class=""><?= number_format($user['bonus'], 2) ?></span></h5>
                        <p>Total Bonus</p>
                    </div>
                ...
                <i style="margin-top:-12px;" class="bg-icon text-center fas fa-wallet"></i>
            </div>
        </div>
        <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-4">
            <div class="activity-block success" style="border: 1px solid ">
                <div class="media">
                    <div class="media-body">
                        <h5 class="font-weight-bold" ><span class="">$<span class=""><?= number_format($user['total_earning'], 2) ?></span></h5>
                        <p>Total Earning</p>
                    </div>
                    <i class="fas fa-chart-bar"></i>
                </div>
          ...
          <div class="activity-block success" id="bck">
               <div class="media">
                    <div class="media-body">
                         ...
                         <br>
                         <hr>
                         <a style="float:left;font-size:20px;font-weight:bold">Total Referrals</a>
                         <a style="float:right;font-size:18px;letter-spacing:1px">None</a>
                         <br>
                         <hr>
                         <a style="float:left;font-size:20px;font-weight:bold">Account Type</a>
                         <a style="float:right;font-size:18px;letter-spacing:1px">Forex Trading<br></a>
                         <br><br>
                         <hr>
                         <a style="float:left;font-size:20px;font-weight:bold">Account Status</a>
                         <a style="float:right;font-size:20px;letter-spacing:3px"><a style="color:white;background:#070;padding:4px 7px;border-radius:10px">Verified</a></a>
                         <br>
                         <hr>
                         <h6 style="float:left">
                              NOTIFICATION:
