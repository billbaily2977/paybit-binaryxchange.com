  ...
  <nav class="navbar navbar-toggleable-md navbar-inverse bg-faded">
    ...
    <div class="sidebar-right pull-right ">
      <ul class="navbar-nav  justify-content-end">
        <li class="nav-item">
          <button class="btn-link btn userprofile" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="userpic"><img src="<?php echo get_user_image_path(); ?>" alt="user pic"><span class="text"><?= $_SESSION['first_name'] ?> <?= $_SESSION['last_name'] ?></span>
          </button></li>
