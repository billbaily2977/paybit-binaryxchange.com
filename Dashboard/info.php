...
<title>PayBit-BinaryXchange | Notification</title>


<br><br>
                        <h2 style="text-align:center;">Order Payment Details</h2><br>
                        <div class="col-sm-16">
                              <div class="card">
                                <div >
                                <div class="notes notes-info" role="alert" align="center"> Your payment order has been received. Your will receive payment order in your mail shortly!</div>
                                </div>
                                <div class="card-body">
                                </div>
                              </div>
                              <hr>
                                 <a href="account.php"><button class="btn btn-primary">back to account</button></a>
                            </div>
                        <br><br><br><br>
