...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_FILES["file"]) && $_FILES["file"]["error"] === 0) {
    ...
    if (!in_array($fileExt, $allowedTypes)) {
        ...
        if (!is_writable($uploadDir)) {
            ...
            $newFileName = "image_" . $id . "_" . time() . "." . $fileExt;
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["update_info"])) {
    ...
    if (empty($email)) {
        ...
        if ($stmt->fetch()) {
            ...
            $stmt = $pdo->prepare("UPDATE users SET first_name = ?, last_name = ?, email = ?, state = ?, address = ? WHERE id = ?");
            if ($stmt->execute([$first_name, $last_name, $email, $state, $address, $id])) {
...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST["changePwd_btn"])) {
...
// Use DB values if session is outdated
$imagePath = $user['image_path'] ?? 'public/img/profile/default.png';
...
<head>
  ...
  <link rel="shortcut icon" href="public/img/assets/favicon.png" type="image/x-icon">
  <!-- <title>PayBit-BinaryXchange | Dashboard</title> -->
  ...
  <link href="public/vendor/datatables/css/dataTables.bootstrap4.css" rel="stylesheet">
  <link href="public/vendor/datatables/css/responsive.dataTables.min.css" rel="stylesheet">
  <link href="public/vendor/jquery-jvectormap/jquery-jvectormap-2.0.3.css" rel="stylesheet">
  <link rel="stylesheet" href="public/css/dark_grey_adminux.css" type="text/css">
...
<body oncut="return false" class="menuclose menuclose-right">
...
<div class="sidebar-left">
  ...
  <ul class="nav flex-column in" id="side-menu">
    ...
    <li class="nav-item "> <a href="javascript:void(0)" class="menudropdown nav-link">Where to Buy Coin<i class="fa fa-angle-down "></i></a>
      <ul class="nav flex-column nav-second-level ">
        <li class="nav-item"><a class="nav-link" href="https://www.luno.com" target="_blank"><i class="fas fa-coins"></i> Luno</a></li>
        <li class="nav-item"><a class="nav-link" href="https://www.remitano.com" target="_blank"><i class="fas fa-coins"></i> Remitano</a></li>
        <li class="nav-item"><a class="nav-link" href="https://www.moonpay.io" target="_blank"><i class="fas fa-coins"></i> Moonpay</a></li>
        <li class="nav-item"><a class="nav-link" href="https://www.localbitcoins.com" target="_blank"><i class="fas fa-coins"></i> Local Bitcoin</a></li>
        <li class="nav-item"><a class="nav-link" href="https://www.payful.com" target="_blank"><i class="fas fa-coins"></i> Paxful</a></li>
        <li class="nav-item"><a class="nav-link" href="https://www.coinbase.com" target="_blank"><i class="fas fa-coins"></i> Coinbase</a></li>
        <li class="nav-item"><a class="nav-link" href="https://www.ramp.network/buy" target="_blank"><i class="fas fa-coins"></i> Ramp</a></li>
        <li class="nav-item"><a class="nav-link" href="https://openocean.banxa.com" target="_blank"><i class="fas fa-coins"></i>Banxa</a></li>
        <li class="nav-item"><a class="nav-link" href="https://www.chainbits.com" target="_blank"><i class="fas fa-coins"></i> Chainbits</a></li>
        <li class="nav-item"><a class="nav-link" href="https://www.bitcoin.com" target="_blank"><i class="fas fa-coins"></i> Bitcoin</a></li>
        <li class="nav-item"><a class="nav-link" href="https://www.coinmama.com" target="_blank"><i class="fas fa-coins"></i> Coinmama</a></li>
      </ul>
      <!-- /.nav-second-level -->
    </li>
  ...
  <ul class="nav flex-column in">
    <li class="nav-item ">
      <div class="nav-link">
        <h5><span><?= date("Y-d-m, H:i:s") ?></span></h5>
      </div>
    </li>
    <li class="nav-item ">
    </li>
...
<title>PayBit-BinaryXchange | Account Settings</title>
    ...
    <form method="POST" action autocomplete="off">
      <div class="card">
        <div class="card-header">
          <span>
          <h3 style="color:green;text-align:center"><?= htmlspecialchars($success) ?></h3>
          </span>
          <h6 class="card-title">PROFILE  SETTINGS  
            <!-- || Reg. Date 12th Sep 2025 03:09pm -->
        </h6>
        ...
        <div class="card-body">
          <div class="form-group row">
            <div class="col-8">
              <label for="example-number-inputf" class="col-16 col-form-label"><i class="fa fa-user"></i> First name</label>
              <input class="form-control" type="text" value="<?= $_SESSION['first_name'] ?>" name="first_name" id="example-number-inputf" required>
            </div>
            <div class="col-8">
              <label for="example-number-inputl" class="col-16 col-form-label"><i class="fa fa-user"></i> Last Nmae</label>
              <input class="form-control" type="text" value="<?= $_SESSION['last_name'] ?>" name="last_name" id="example-number-inputl" required>
            </div>
          </div>
          <div class="form-group row">
            <div class="col-8">
          ...
          <div class="form-group row">
            ...
            <div class="col-8">
              ...
              <input class="form-control" type="text" value="<?= htmlspecialchars($user['state'] ?? '') ?>" name="state">
            </div>
          </div>
          <div class="form-group row">
            <div class="col-16">
              <label for="example-number-inputa" class="col-16 col-form-label"><i class="fa fa-address"></i> Resident Address</label>
              <textarea class="form-control" rows="4" name="address"><?= htmlspecialchars($user['address'] ?? '') ?></textarea>
            </div>
          </div>
          <div class="form-group row">
            <div class="col-16">
              <center>
                <a class="btn btn-outline-primary" type="button"  name="request_btn" href="#cp">Change Profile</a>
                <span>|<span>
                <a class="btn btn-outline-primary" type="button"  name="request_btn" href="#cps">Change Password</a>
                    <span>||<span>
                        <input class="btn btn-outline-info" type="reset" name="request_btn" value="Default">
                        <span>|<span>
                            <input class="btn btn-primary" type="submit" name="update_info" value="Save Changes">
              </center>
            </div>
          </div>
        </div>
...
<div class="row" id="cps">
  ...
  <div class="col-sm-16 col-md-8">
    <form method="POST" enctype="multipart/form-data" action id="cp">
      <div class="card">
        <div class="card-header">
        ...
        <div class="card-body">
          <center>
            <div class="form-group row">
              ...
              <div class="col-16">
                <img style="width:200px;height:200px;border-radius:30px" class="form-control" src="<?= htmlspecialchars($imagePath) ?>">
          ...
          <div class="col-16">
            <center>
              <input class="btn btn-outline-primary" type="submit" name="changeImg_btn" value="Upload file">
            </center>
          </div>
        </div>
      </div>
...
<script src="public/vendor/cicular_progress/circle-progress.min.js" type="text/javascript"></script>
<script type="text/javascript" src="public/vendor/sparklines/jquery.sparkline.min.js"></script>
<script src="public/vendor/jquery-jvectormap/jquery-jvectormap.js"></script>
<script src="public/vendor/jquery-jvectormap/jquery-jvectormap-world-mill-en.js"></script>
<script src="public/vendor/chartjs/Chart.bundle.min.js" type="text/javascript"></script>
<script src="public/vendor/chartjs/utils.js" type="text/javascript"></script>
<script src="public/vendor/spincrement/jquery.spincrement.min.js" type="text/javascript"></script>
<script src="public/vendor/datatables/js/jquery.dataTables.min.js"></script>
<script src="public/vendor/datatables/js/dataTables.bootstrap4.js"></script>
<script src="public/vendor/datatables/js/dataTables.responsive.min.js"></script>
<script src="public/js/adminux.js" type="text/javascript"></script>
