...
// Show success/error messages from payment
$msg = $_SESSION['msg'] ?? '';
unset($_SESSION['msg']);
?>
...
<div class="sidebar-left">
  ...
  <ul class="nav flex-column in">
    <li class="nav-item ">
      <div class="nav-link">
        <h5><span>2025/09/13 12:05pm</span></h5>
      </div>
    </li>
    <li class="nav-item ">
    </li>
...
<title>PayBit-BinaryXchange | Deposit</title>
  ...
  <div class="col-sm-16 col-md-8">
    <div class="card">
      <div class="card-header align-items-start justify-content-between flex">
        <h4 class="pull-left">Deposit Using Bitcoin | Ethereum(ERC20)  </h4>
      ...
      <div class="card-body" id="btc_deposit">
        <div class="ncard small">
          <h6>Bitcoin | Ethereum  Deposit Method</h6>
          <hr>
          <b>
            <span style="color:gold"> Please make sure you upload your payment proof for quick payment verification</span><br>
            <span style="color:#17a2b8 !important">On confirmation, our system will automatically Fund your account and notify you via email address.
            </span>
          </b>
          <br>
          <form action="payment.php" method="POST">
            <div class="form-group row">
              ...
              <div class="col-16">
                <input class="form-control" type="number" step="any" value="" placeholder="0.00" name="invest" min="10" id="exa1" required>
                <input type="hidden" value="Deposit" name="action" required>
              </div>
            </div>
            <div class="form-group row">
              <div class="col-16">
                <input class="btn btn-primary" style="float:right" type="submit" name="investment" value="Make Deposit">
              </div>
            </div>
          </form>
        </div>
    ...
    <div class="card">
      ...
      <div class="card-body" id="order_depo">
        <div class="ncard small">
          ...
          <hr>
          <b>
            <span style="color:gold">Once requested, you will receive the payment details via our support mail....</span><br>
            <span style="color:#17a2b8 !important"> Once payment is made using this method you are to send your payment
              proof to our support mail <a href="mailto:support@paybit-binaryxchange.com">support@paybit-binaryxchange.com</a>
            </span>
          </b>
          <br>
          <form action="info" method="POST">
            <input class="form-control" type="hidden" value="" name="name" id="exam2" required>
            <input class="form-control" type="hidden" value="" name="email" id="exam2" required>
            <div class="form-group row">
              <label for="exam4" class="col-16 col-form-label" style="text-align:left">Payment Option For<font color="crimson">*</font></label>
              <div class="col-16">
                <select class="form-control" value="" name="deposit_type" id="exam4" required>
                  <option disabled value="" selected>--Select Payment Option --</option>
            ...
            <div class="form-group row">
              <div class="col-16">
                <input class="btn btn-primary" style="float:right"  type="submit" name="request_deposit" value="Request"></center>
              </div>
            </div>
          </form>
        </div>
