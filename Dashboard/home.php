...
<script type="text/javascript">
    (function() {
        var options = {
            whatsapp: "‪+1 (913) 208‑5046‬", // WhatsApp number
...
<div class="sidebar-left">
  ...
  <ul class="nav flex-column in" id="side-menu">
    ...
    <li class="nav-item"> <a class="nav-link" href="mailto:support@pro-binaryxchange.com"><i class="fa fa-comment"></i>Contact Support</a> </li>
...
<title><span class="text" id="clientName"></span>| Dashboard</title>
<span class="mt-0 mb-1" id="sidebarName"></span>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" crossorigin="anonymous" referrerpolicy="no-referrer" />    <div class="row mgt5">
            ...
            <div class="activity-block success" style="border: 1px solid ">
                <div class="media">
                    <div class="media-body">
                        <h5 class="font-weight-bold" style="color:crimson">$<span class="">0.00</span></h5>
                        <p>Total Deposit</p>
                    </div>
        ...
        <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-4">
            <div class="activity-block success" style="border: 1px solid ">
                <div class="media">
                    <div class="media-body">
                        <h5 class="font-weight-bold" style="color:#070">$<span class="">0.00</span></h5>
                        <p>Total Balance</p>
                    </div>
        ...
        <div class="col-8 col-sm-8 col-md-8 col-lg-8 col-xl-4">
            <div class="activity-block success" style="border: 1px solid ">
                <div class="media">
                    <div class="media-body">
                        <h5 class="font-weight-bold"><span class="">$<span class="">0.00</span></h5>
                        <p>Total Bonus</p>
                    </div>
          ...
          <div class="activity-block success" id="bck">
               <div class="media">
                    <div class="media-body">
                         ...
                         <a style="float:right;font-size:20px;letter-spacing:3px"><b style="color:white;background:#070;padding:4px 7px";border-radius:10px>Verified</b></a>
                         <br>
                         <hr>
                         <h6 style="float:left">
                              NOTIFICATION:
...
<div class="row">
  <div class="col-md-12">
    <div class="form-group row">
      ...
      <div class="col-10">
        <input type="text" style="color:black" class="form-control" id="referral_link" value="https://www.pro-binaryxchange.com/Dashboard/register" readonly="">
      </div>
    </div>
  </div>
