...
<div class="sidebar-left">
  ...
  <ul class="nav flex-column in" id="side-menu">
    ...
    <li class="nav-item"> <a class="nav-link" href="accountv"><i class="fa fa-home"></i>Account</a> </li>
...
<title>PayBit-BinaryXchange | Account Upgrade</title>
        ...
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-16">
              ...
              <input class="form-control" style="background:transparent" name="name" type="text" value="<?= $_SESSION['last_name'] ?>  <?= $_SESSION['first_name'] ?>" id="example-text-input" readonly>
            </div>
          </div>
          ...
          <div class="form-group row">
            <div class="col-16">
              <center><input class="btn btn-outline-primary" type="submit" name="upgrade_p" value="UPGRADE"></center>
            </div>
          </div>
      </form>
    </div>
