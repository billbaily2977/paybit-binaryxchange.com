...
<body class="menuclose menuclose-right" style="background:gray">
    ...
    <nav class="navbar navbar-toggleable-md sign-in-header">
      ...
      <div class="sidebar-right pull-right">
        <ul class="navbar-nav  justify-content-end">
          ...
          <li style="margin:4px"><a href="../home.php" style="background:#3f48cc;color:white" class="btn btn-primary">Home</a></li>
  ...
  <div class="wrapper-content-sign-in p-0">
    ...
    <title>PayBit-BinaryXchange | Forgot Password</title>

<div class="container text-center">
<h1 class="form-signin-heading text-white"><i class="fa fa-"></i>Password Reset</h1>
<form class="form-signin1 light"   action="" method="POST">
...
<span><h3 style="color:green;text-align:center"></h3></span>
  <h2 class="tex-black mb-4">Reset Password</h2>
