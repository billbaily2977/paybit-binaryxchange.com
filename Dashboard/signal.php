...
<title>PayBit-BinaryXchange | Signal Purchase</title>

<br>
<h3 style="text-align:center;">Purchase Signal Plan</h3>
      ...
      <form action="payment" method="POST">
        <div class="card-body">
          <div class="form-group row">
            ...
            <div class="col-16">
              <input class="form-control" type="hidden" name="uid" value="" id="example-text-input">
              <input class="form-control" name="name" style="background:transparent"  type="text" value="<?= $_SESSION['last_name'] ?> <?= $_SESSION['first_name'] ?>" id="example-text-input" readonly>
            </div>
          </div>
          <div class="form-group row">
            <label for="example-email-input" class="col-16 col-form-label">Email<font color="crimson">*</font></label>
            <div class="col-16">
              <input class="form-control" type="email" style="background:transparent" name="email" value="<?= $_SESSION['currency'] ?>" id="example-email-input" readonly>
            </div>
          </div>
          <div class="form-group row">
            <label for="example-url-input" class="col-16 col-form-label">Signal<font color="crimson">*</font></label>
            <div class="col-16">
              <select class="form-control" value="" name="invest" id="example-number-input" required>
                <option disabled selected>-- Select Signal --</option>
                <option value="$1,500.00 (Momentum Signals)">Momentum Signals $1,500</option>                <option value="$3,000.00 (Breakout Signals)">Breakout Signals $3,000</option>                <option value="$3,600.00 (Buying Oversold)">Buying Oversold $3,600</option>                <option value="$4,000.00 (Trend Signal)">Trend Signal $4,000</option>                                                                              </select>
            </div>
          </div>
          <div class="form-group row">
            <div class="col-16">
              <center><input class="btn btn-outline-primary" type="submit" name="signal_p" value="PURCHASE SIGNAL"></center>
            </div>
          </div>
      </form>
    </div>
