...
!(function(e, t) {
    ...
    "use strict";
    var t, n, o, r, a, i, c, u = {}, l = "querySelector"in document && "addEventListener"in e, s = {
    ...
    u.animateScroll = function(n, o, i) {
        ...
        if (d || h) {
            var m = e.pageYOffset;
            l.selectorHeader && !r && (r = document.querySelector(l.selectorHeader)),
            a || (a = O(r));
            var b, I, S = d ? n : p(h, a, parseInt(l.offset, 10)), E = S - m, A = v(), j = 0, L = function(t, r, a) {
                var i = e.pageYOffset;
                (t == r || i == r || e.innerHeight + i >= A) && (clearInterval(a),
                H(n, r, d),
                l.callback(n, o))
            }, w = function() {
                j += 16,
    ...
    var I = function(t) {
      ...
      , S = function(r) {
        if (0 === r.button && !r.metaKey && !r.ctrlKey && (o = h(r.target, t.selector),
        o && "a" === o.tagName.toLowerCase() && o.hostname === e.location.hostname && o.pathname === e.location.pathname && /#/.test(o.href))) {
            var a = m(o.hash);
            if ("#" === a) {
                r.preventDefault(),
                n = document.body;
                var i = n.id ? n.id : "smooth-scroll-top";
                return n.setAttribute("data-scroll-id", i),
                n.id = "",
                void (e.location.hash.substring(1) === i ? I() : e.location.hash = i)
            }
            n = document.querySelector(a),
            n && (n.setAttribute("data-scroll-id", n.id),
            n.id = "",
            o.hash === e.location.hash && (r.preventDefault(),
            I()))
        }
    }
      , E = function(e) {
    ...
    return u.destroy = function() {
        t && (document.removeEventListener("click", S, !1),
...
!function() {
    ...
    function t() {
        if (!B && document.body) {
            ...
            window.innerHeight,
            t.scrollHeight;
            L = document.compatMode.indexOf("CSS") >= 0 ? o : t,
            D = t,
            e(),
            top != self && (Y = !0),
            H.fixedBackground || X || (t.style.backgroundAttachment = "scroll",
    ...
    function n(e, t, o) {
        ...
        1 != H.accelerationMax) {
            var n = Date.now()
              , r = n - R;
            if (r < H.accelerationDelta) {
                var a = (1 + 50 / r) / 2;
                a > 1 && (a = Math.min(a, H.accelerationMax),
                t *= a,
                o *= a)
            }
            R = Date.now()
              ...
              , l = function(n) {
                for (var r = Date.now(), a = 0, c = 0, u = 0; u < q.length; u++) {
                    var d = q[u]
                      , s = r - d.start
                      , m = s >= H.animationTime
                      , f = m ? 1 : s / H.animationTime;
                    H.pulseAlgorithm && (f = k(f));
                ...
                c && (e.scrollTop += c)),
                t || o || (q = []),
                q.length ? _(l, e, 1e3 / H.frameRate + 1) : P = !1
            };
            _(l, e, 0),
            P = !0
        }
    ...
    function r(e) {
        ...
        if (!r || e.defaultPrevented || e.ctrlKey)
            return !0;
        if (p(D, "embed") || p(o, "embed") && /\.pdf/i.test(o.src) || p(D, "object"))
            return !0;
        ...
        1 === e.deltaMode && (a *= 40,
        i *= 40),
        !H.touchpadSupport && v(i) ? !0 : (Math.abs(a) > 1.2 && (a *= H.stepSize / 120),
    ...
    function a(e) {
        ...
        if (r.test(t.nodeName) || p(t, "input") && !a.test(t.type) || p(D, "video") || g(e) || t.isContentEditable || e.defaultPrevented || o)
            return !0;
        if ((p(t, "button") || p(t, "input") && a.test(t.type)) && e.keyCode === N.spacebar)
            return !0;
    ...
    function k(e) {
        return e >= 1 ? 1 : 0 >= e ? 0 : (1 == H.pulseNormalize && (H.pulseNormalize /= S(1)),
        S(e))
    }
    function x(e) {
        for (var t in e)
            z.hasOwnProperty(t) && (H[t] = e[t])
    }
    var D, M, T, E, C, z = {
        frameRate: 150,
        animationTime: 300,
        ...
        x: 0,
        y: 0
    }, B = !1, L = document.documentElement, O = [], K = /^Mac/.test(navigator.platform), N = {
        left: 37,
        up: 38,
        right: 39,
        down: 40,
    ...
    }()), $ = window.navigator.userAgent, U = /Edge/.test($), W = /chrome/i.test($) && !U, G = /safari/i.test($) && !U, J = /mobile/i.test($), Q = (W || G) && !J;
...
function parallaxen() {
    function a() {
        ...
        function c() {
            if (F) {
                for (var a = k.length, f = e(); a--; )
                    d(k[a], f, o, p);
                F = !1
            }
            s && (D += -v * b(u, 0, A, C),
            (D > B || -B > D) && (E.scrollBy(0, D),
            D = 0),
            u++,
            u > C && (u = 0,
            s = !1,
        ...
        function g(a) {
            G.vosSa === !0 && (a.preventDefault && a.preventDefault(),
            v = a.vorw ? -a.deltaY / 4 : 1 == a.deltaMode ? -a.deltaY / 3 : 100 === Math.abs(a.deltaY) ? -a.deltaY / 120 : -a.deltaY / 40,
            v = -y > v ? -y : v,
            v = v > y ? y : v,
            s = !0,
            u = z)
        ...
        this.documentReady = function(a) {
            ...
            /Android|iPad|iPhone|iPod|BlackBerry|Windows Phone/i.test(navigator.userAgent || navigator.vendor || window.opera) ? jQuery(".parallax") : l && (G.vope(),
            G.vops()),
            h(a) ? void a() : void 0
        }
        ,
        this.windowLoad = function() {
            ...
            r = j(),
            window.Parallaxen.vope()
        }
        ,
        this.vops = function() {
            i() && (E = jQuery().get(0),
            "undefined" != typeof E && (E.scrollBy = function(a) {
                this.scrollTop += j,
                this.scrollLeft += a
            }
            )),
            "undefined" != typeof E && (E.addEventListener("scroll", f, !1),
    ...
    function(a, b) {
        function c(b, c, g, h) {
            b[d](f + c, "wheel" == e ? g : function(b) {
                ...
                return "mousewheel" == e ? (c.deltaY = -.025 * b.wheelDelta,
                b.wheelDeltaX && (c.deltaX = -.025 * b.wheelDeltaX)) : c.deltaY = b.detail / 3,
                g(c)
            }
            , h || !1)
        }
        var d, e, f = "";
        a.addEventListener ? d = "addEventListener" : (d = "attachEvent",
        f = "on"),
        e = "onwheel"in b.createElement("div") ? "wheel" : "undefined" != typeof b.onmousewheel ? "mousewheel" : "DOMMouseScroll",
