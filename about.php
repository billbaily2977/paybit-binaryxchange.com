...
<!-- End Header Section -->
    <title>About us | PayBit-BinaryXchange</title>
    
    <!-- Start Hero Section -->
    <section id="about-page" class="page-wrap contact" style="margin-top:100px">
        <div class="hero-container container">
            <div class="hero-content">
                <div class="col-sm-12 m-auto text-center white">
                    <h3 class="h1-md mb10 text-uppercase">About Us</h3>
                    <h4 class="subheading">Home/about</h4>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="row">
        <div class="col-md-12">
            <div class="heading m-auto text-center " style="padding-top:20px;margin-bottom:-10px">
                <h2 class="f-xbold"> About PayBit-BinaryXchange </h2>
                <!-- <hr class="seperator"> -->
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="about-wrap">
                    <p>
                        PayBit-BinaryXchange is fully automated trading and crypto mining platform that gives you full control of your investment, and allows you to withdraw your capital and profit at anytime.
                        We were one of the first to invest in Crypto Currencies. PayBit-BinaryXchange is a legal leading blockchain investment company, which is currently based in USA                    </p>
                    <p>
                        Our mission is to act as a catalyst for universal adoption and blockchain innovation. We focus only on investing in blockchain technologies. Our team has experience in both traditional
                        financing and emerging blockchain technology
                    </p>
                    <p>
                    It was established by a group of professional traders and investors, who have fore seen
...
<div class="tradingview-widget-container" style="position:absolute;pointer-events:none">
  ...
  <!-- TradingView script with inline JSON -->
  <script type="text/javascript" src="https://s3.tradingview.com/external-embedding/embed-widget-ticker-tape.js" async>
  </script>
  <script type="text/javascript">
                ...
                <div class="widget contact-widget">
                    ...
                    <ul class="footer-contact">
                        <li><i class="fa fa-map-marker"></i>45512 Westmeath Way Unit B32, Great Mills, MD 20634,</li>
                                                    <li><i class="fa fa-whatsapp"></i> <span><a href="https://wa.me/‪+1 (650) 209‑2324‬">‪+1 (913) 208‑5046‬</a></span></li>
