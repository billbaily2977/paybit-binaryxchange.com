...
<!-- End Header Section -->
<title>Contact Us | PayBit-BinaryXchange</title>

<!-- Start Hero Section -->
<section id="contact-page" class="page-wrap contact" style="margin-top:100px">
    <div class="hero-container container">
        <div class="hero-content">
            <div class="col-sm-12 m-auto text-center white">
                <h3 class="h1-md mb10 text-uppercase">Contact Us</h3>
                <h4 class="subheading">Home/contact</h4>
            </div>
        </div>
    </div>
</section>
...
<section id="contact-info" class="bg-gray pt40 pb40">
    <div class="row">
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6 ">
                    <div class="short-contact">
                        ...
                        <h3>Grow Your Financial Stability</h3>
                        <p>Trade in the world’s financial markets, with a simple and user friendly online platform.</p>
                        <ul class="nav navbar-nav">
                            <li class="quote">
                                <a href="Dashboard/register.php">Get Started</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6 col-sm-6 ">
                    <div class="short-contact info">
                        <h4>Get Free Consultant</h4>
                        <ul>
                            <li>Location : <span>45512 Westmeath Way Unit B32, Great Mills, MD 20634,USA </span></li>
                                                            <li>Wahatsapp : <span>#</span></li>
                                                        <li>Email : <span><a href="mailto:support@PayBit-binaryxchange.com">support@PayBit-binaryxchange.com</a></span></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<section id="contact-form">
    <div class="container pt100 pb100">
        <div class="heading m-auto text-center mb30">
            ...
            <p>Drop a message here and we will get back to your as quick as possible...</p>
        </div>


        <div class="col-md-8 col-sm-8 m-auto">
            <form action="" method="POST">
                <!-- name="contact" id="contact" novalidate -->
                <div class="text-center">
                    ...
                    <div class="form-group">
                        <textarea class="form-control" name="message" id="message" cols="40" rows="6" placeholder="Your Message... *" required></textarea>
                            ...
                            <div class="input-group-prepend">
                                <img src="../captcha/captcha" alt="" srcset="">
                            </div>
                    ...
                    <div class="form-group">
                        <button type="submit" name="contact" class="btn btn-hero">Send Message</button>
                    </div>
                </div>
            </form>
        </div>
